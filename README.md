# TCN Forecaster in NeuralForecast

TCN Forecaster for the Forecasting problem category as per Ready Tensor specifications.
...
- A **TCN Forecaster** algorithm built using **NeuralForecast**
